...
Module timer
      ...
      Real (Kind=DEF_DBL_PREC) :: times(14)
      ...
      Integer, parameter :: ti_iatLcu = 10
      
      Integer, parameter :: ti_bar = 11
      Integer, parameter :: ti_hdf = 12
      Integer, parameter :: ti_mpi = 13
      Integer, parameter :: ti_other = 14
...
Contains
      ...
      Subroutine write_times(timef, times, t, ik, flag)
         ...
         Write (timef, '("  IatLcu Time = ", f12.4)') times(ti_iatLcu)
