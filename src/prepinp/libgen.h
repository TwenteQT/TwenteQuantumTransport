...
#define kboltz 1.3806488e-23 //	J* K^−1
#define hbar 1.054571726e-34  // J*s
#define caem 1.660538921e-27 //kg
#define debcf  (hbar*hbar/(caem*kboltz))
#define bohrrad 0.52917721092e-1 // nm
#define aunit (5.2917721092e-1) //a.u
#define ES_ii2 200
...
#define LOGMSG(log_level,  ...)                                       \
    do {                                                                \
        if (log_level <= LOG_MAX)                                       \
                log_print( __FILE__, __LINE__,  __VA_ARGS__); \
    } while(0)
...
void loadmasks(t_scgeom *geom,int n1,int n2);
